...
void main() {
  ...
  test('migration from v1 to v2 does not corrupt data', () async {
    ...
    final oldStoresData = <v1.StoresData>[];
    final expectedNewStoresData = <v2.StoresData>[];
    ...
    await verifier.testWithDataIntegrity(
      ...
      createItems: (batch, oldDb) {
        batch.insertAll(oldDb.stores, oldStoresData);
        batch.insertAll(oldDb.receipts, oldReceiptsData);
      },
      validateItems: (newDb) async {
        expect(expectedNewStoresData, await newDb.select(newDb.stores).get());
        expect(
